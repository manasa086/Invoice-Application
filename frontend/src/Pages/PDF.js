    ...
    if(invoice && fromData)
    {
      ...
      <hr color="black"></hr>  
                ...
                <div className="container heading-pdf">
                    ...
                    <div className="col">
                    <img src={logo} className="pull-right img-responsive  header-image image1 float-right" ></img>
      ...
      <tbody>
        ...
        <tr className="tr1"><td></td><td></td><td></td><td></td><td></td><td></td></tr>
                ...
                <Pdf targetRef={ref} filename="invoice.pdf">
                    {({toPdf})=><button className="btn  btn5 btn-secondary" onClick={toPdf}>Capture as PDF</button>}
                </Pdf>
                </div>
                </div>
